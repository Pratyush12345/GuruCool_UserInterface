...
class FreeClassDialogBox extends StatelessWidget {
  @override
          ...
          child: Column(
            children: [
              Container(
                ...
                child: Text(
                  'Are you sure you want this class to be a “Free class” ?',
...
void showFreeClassDialogBox(BuildContext context) {
  showDialog(
      context: context,
      builder: (BuildContext context) {
        return FreeClassDialogBox();
      });
}

...
class HolidayDialogBox extends StatelessWidget {
  @override
          ...
          child: Column(
            children: [
              Container(
                ...
                child: Text(
                  'Are you sure, you want this day to be a “Full day Holiday” ?',
...
void showHolidayDialogBox(BuildContext context) {
  showDialog(
      context: context,
      builder: (BuildContext context) {
        return HolidayDialogBox();
      });
}

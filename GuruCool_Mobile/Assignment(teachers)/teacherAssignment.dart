                      ...
                      return Column(children: [
                        Container(
                          ...
                          child: Row(children: [
                            ...
                            SizedBox(width: SizeConfig.screenWidth * 0.03333),
                            Container(
                            ...
                            SizedBox(width: SizeConfig.screenWidth * 0.04167),
                          ]),
                        ),
                        Container(
                          ...
                          child: Row(children: [
                            SizedBox(width: SizeConfig.screenWidth * 0.047222),
                            Text(this.className,
                                style: TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.w300,
                            ...
                            SizedBox(
                                width: SizeConfig.screenWidth * 0.047222 / 2),
                            Container(
                              color: Colors.white,
                              width: 0.5,

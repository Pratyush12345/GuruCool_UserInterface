...
children:[
Icon(MdiIcons.youtube,color: Colors.white,size:SizeConfig.screenWidth*0.045),  
...
mainAxisAlignment: MainAxisAlignment.center,  
children:[
Icon(Icons.picture_as_pdf,color: Colors.white,size:SizeConfig.screenWidth*0.045),  
...
mainAxisAlignment: MainAxisAlignment.center,  
children:[
Icon(MdiIcons.clock,color: Colors.white,size:SizeConfig.screenWidth*0.045),  
...
children:[
Container(
padding: EdgeInsets.symmetric(horizontal:SizeConfig.b * 4.722,vertical:SizeConfig.screenHeight*0.0265625),
child: Column(
children: [
TextField(
decoration: InputDecoration(
...
builder: (BuildContext context) {
return Dialog(
insetPadding: EdgeInsets.symmetric(horizontal:SizeConfig.screenWidth * 0.0833),
shape: RoundedRectangleBorder(
borderRadius: BorderRadius.circular(SizeConfig.b * 2),
),
child:Column(

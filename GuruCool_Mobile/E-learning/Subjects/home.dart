...
onPressed: () => {},
child: Icon(
Icons.add,size: SizeConfig.screenWidth * 0.0486*1.5,color: Colors.white,),
backgroundColor:gc,
),
body: TabBarView(children: [
Subject(sub:"Mathematics",teacher:"Nikhil Vyas"),//passing parameters of subject list and teacher lists
Container(
